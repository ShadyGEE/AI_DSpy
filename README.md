...
- **Date Range**: The database has 2012-2023 data (not 1997), so I updated the sample questions to use 2013 instead. If we kept 1997, all answers would be wrong and only based on assumptions, also updated marketing_calendar.md to 2013.
